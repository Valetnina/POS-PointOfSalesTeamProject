  ...
  public class MessengerBalance
    {
        ...
        private static MessengerBalance _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerBalance Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new MessengerBalance();
                        }
                    }
                }
