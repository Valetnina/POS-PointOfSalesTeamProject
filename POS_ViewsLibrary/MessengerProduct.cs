  ...
  public class MessengerPoduct
    {
        ...
        private static MessengerPoduct _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerPoduct Default
        {
            get
            {
                if (_instance == null)
