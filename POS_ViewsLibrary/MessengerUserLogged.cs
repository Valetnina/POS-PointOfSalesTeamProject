...
{
  public class MessengerUserLogged
    {
        ...
        private static MessengerUserLogged _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerUserLogged Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new MessengerUserLogged();
                        }
                    }
                }
