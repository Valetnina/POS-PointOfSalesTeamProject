  ...
  public  class MessengerLogout
    {
        ...
        private static MessengerLogout _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerLogout Default
        {
            get
            {
                if (_instance == null)
